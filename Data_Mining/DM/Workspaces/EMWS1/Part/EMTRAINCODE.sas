...
komputer = 1
then do;
if (1247+1-_C000004)*_genvalue_ <= (499 - _C000001) then do;
_C000001 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (1247+1-_C000004)*_genvalue_ <= (499 - _C000001 + 374 - _C000002) then do;
_C000002 + 1;
...
komputer = 0
then do;
if (753+1-_C000008)*_genvalue_ <= (301 - _C000005) then do;
_C000005 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (753+1-_C000008)*_genvalue_ <= (301 - _C000005 + 226 - _C000006) then do;
_C000006 + 1;
output EMWS1.Part_VALIDATE;
end;
else do;
