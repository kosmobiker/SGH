...
%let EM_NUM_VARS = 18;
   %macro EM_VARS;
    CHURN CZAS_W DZIENMIN DZIENOPL DZIENROZ L_ROZBOK L_WIAD M_MIN M_OPL M_ROZM
   NOCMIN NOCOPL NOCROZ PLAN_M POCZTA_G WIECZMIN WIECZOPL WIECZROZ
   %mend EM_VARS;
%let EM_NUM_CLASS = 4;
   %macro EM_CLASS;
    CHURN L_ROZBOK PLAN_M POCZTA_G
   %mend EM_CLASS;
%let EM_NUM_INTERVAL = 14;
   %macro EM_INTERVAL;
    CZAS_W DZIENMIN DZIENOPL DZIENROZ L_WIAD M_MIN M_OPL M_ROZM NOCMIN NOCOPL
   NOCROZ WIECZMIN WIECZOPL WIECZROZ
   %mend EM_INTERVAL;
...
%let EM_NUM_INPUT = 17;
   %macro EM_INPUT;
    CZAS_W DZIENMIN DZIENOPL DZIENROZ L_ROZBOK L_WIAD M_MIN M_OPL M_ROZM NOCMIN
   NOCOPL NOCROZ PLAN_M POCZTA_G WIECZMIN WIECZOPL WIECZROZ
   %mend EM_INPUT;
